...
public class Crypter {
     ...
     *
     * @param plainByteArray The text that should get signed
     ...
     */
    public static byte[] sign(byte[] plainByteArray, PrivateKey privateKey) throws NoSuchAlgorithmException, InvalidKeyException, SignatureException {

            Signature privateSignature = Signature.getInstance("SHA256withRSA");
            privateSignature.initSign(privateKey);
            privateSignature.update(plainByteArray);
     ...
     *
     * @param plainByteArray The signed byte array that got generate by the sign methode
     ...
     */
    public static boolean verify(byte[] plainByteArray, byte[] signature, PublicKey publicKey) throws NoSuchAlgorithmException, InvalidKeyException, SignatureException {
            Signature publicSignature = Signature.getInstance("SHA256withRSA");
            publicSignature.initVerify(publicKey);
            publicSignature.update(plainByteArray);
