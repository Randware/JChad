...
Simple head to the [releases](https://github.com/Randware/JChad/releases) page get it. You can also get the other components as standalone .jar files from there, if desired.
